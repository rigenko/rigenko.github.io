...
// get the rest of the data, form a message to the administrator
$line = true;
...
// we form a message to the administrator
$message = "
    <h3>" . $site_name . "</h3>
    <h2>" . $page . "</h2>
...
// we send a letter to the administrator
if ($json['result'] == 'success') {
    ...
    try {
        ...
        // attachment of files to a letter
        if (isset($_FILES['attachment'])) {
...
if ($json['result'] == 'success' && !$user_email=='' && MAIL_CLIENT) {
    ...
    try {
        ...
        //echo "Message could not be sent. Mailer Error: {$mail->ErrorInfo}";
        //$json['result'] = 'error';
        //$json['error'] = 'Send error' . $mail_client->ErrorInfo;
    }
